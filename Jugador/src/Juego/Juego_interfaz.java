 ...
 * @author JONATAN
 */
public class Juego_interfaz extends javax.swing.JFrame {

    /**
     * Creates new form Juego_interfaz
     */
    public Juego_interfaz() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Juego_interfaz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Juego_interfaz().setVisible(true);
            }
        });
    }
